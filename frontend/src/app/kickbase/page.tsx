  ...
  return (
    <div className="fade-in">
      ...
      <div style={{
        ...
        <ScoringLegend label="Tor (MF)" pts={70} color="#60a5fa" />
        <ScoringLegend label="Tor (AV)" pts={60} color="#facc15" />
        <ScoringLegend label="Vorlage" pts={30} color="#00FF87" />
        <ScoringLegend label="Gelb" pts={-20} color="#fbbf24" />
